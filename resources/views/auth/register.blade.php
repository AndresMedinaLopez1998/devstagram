    ...
    <div class="lg:flex lg:justify-center lg:gap-6 lg:items-center">
        ...
        <div class="lg:w-4/12 bg-white rounded-lg shadow-xl p-6">
            <form action="{{route('register')}}" method="POST">
                ...
                <input type="submit" value="Crear Cuenta" class="bg-sky-600 hover:bg-sky-800 transition-colors cursor-pointer uppercase font-bold p-3 w-full text-white rounded-lg ">
            </form>
        </div>
    </div>
@endsection